...
public class VistaCeldaReservaSemana extends ListCell<Reserva> {
    ...
    
    {
        ...
        hbox.getChildren().addAll(infoLabel); 
    }
        ...
        protected void updateItem(Reserva reservas, boolean empty) {
            ...
            if (empty || reservas == null) {
                ...
                String nombre =  size.ajustarTamaño(reservas.getNombreUsuario(), 30);
                String hora =size.ajustarTamaño(reservas.getHora().toString(), 30);
                String cancha =size.ajustarTamaño(reservas.getTipoDeCancha(), 30);
                String telefono =size.ajustarTamaño(reservas.getTelefono(), 30);
